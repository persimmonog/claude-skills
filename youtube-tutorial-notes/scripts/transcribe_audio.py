...
def transcribe_video(video_path: str, model_size: str = "base", device: str = "cpu", language: str = "auto") -> str:
    """
    转录视频音频为文本
    ...
    transcript = transcriber.transcribe(video_path, language=language)
